...
class AccountScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          _buildRow('Admin', 'admin', '1234'),
          const SizedBox(height: 20),
          _buildRow('Alan', 'alan', '4321'),
          const SizedBox(height: 20),
          Expanded(
            child: Align(
  ...
  Widget _buildRow(String name, String user, String password, {double fontSize = 18}) {
    return SizedBox(
        width: 30,
        height: 50,
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            Text(name, style: TextStyle(color: Colors.black, fontSize: fontSize)),
            Text(user, style: TextStyle(color: Colors.black, fontSize: fontSize)),
            Text(password, style: TextStyle(color: Colors.black, fontSize: fontSize)),
          ],
        ),
    );
  }
